...
export const FaqSection: React.FC = () => {
  ...
  return (
    <section id="faq" className="py-24 px-4 sm:px-8 max-w-7xl mx-auto w-full relative">
      {/* Header */}
      ...
      <div className="flex flex-col md:flex-row gap-4 mb-8">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-11 pr-4 py-3 bg-black/40 border border-white/10 focus:border-purple-500 rounded-xl text-sm text-zinc-200 outline-none transition-colors"
          />
        </div>
        ...
        {filteredFaqs.length > 0 ? (
          filteredFaqs.map((faq, index) => {
            ...
            return (
              <div
                key={index}
                className="rounded-2xl bg-black/40 backdrop-blur-md border border-white/10 overflow-hidden transition-all duration-200"
              >
                <button
                ...
                {isOpen && (
                  <div className="px-6 pb-6 pt-2 text-sm sm:text-base text-zinc-300 font-light leading-relaxed border-t border-white/5">
                    <p>{faq.answer}</p>
          ...
          <div className="p-12 text-center text-zinc-500 font-mono-code text-sm">
